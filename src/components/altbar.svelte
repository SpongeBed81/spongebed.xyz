<script>
  ...
  $: {
    ...
    const find = $status.activities.find((x) =>
      x.name.toLowerCase().startsWith("visual studio")
    );
...
<div class="alt-holder">
  ...
  <div class="content">
    <span
      >"Seeing me doesn't necessarily mean seeing my face. If you understand my
      ideas and my feelings, that's enough." - Mustafa Kemal Atatürk</span
    >
  </div>
</div>
