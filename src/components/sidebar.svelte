<script>
  ...
  function controlNavbar() {
    ...
    root
      ...
      .style[state]("display", "block", "important");
    document.body.style[state]("overflow", "hidden");
    root.querySelector(".resp").innerHTML = icons[+!+open];
    document
      .querySelector(".alt-holder")
      .style[state]("display", "flex", "important");
    open = !open;
  }
</script>
...
<div class="sidebar" bind:this={root}>
  ...
  <div class="hold">
    ...
    <div class="content">
      <div class="routes">
        <a href="/" style={$page.route.id == "/" ? "color: white" : undefined}
          >what I do</a
        >
        <a
          href="/where"
          style={$page.route.id == "/where" ? "color: white" : undefined}
          >where I've done it</a
        >
        <a
          href="/how"
          style={$page.route.id == "/how" ? "color: white" : undefined}
          >how I do it</a
        >
        <a
          href="/etc"
